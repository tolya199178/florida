...
class Event extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('event_title, event_start_date, event_end_date, event_category_id, event_business_id, event_tag, modified_time, created_by, modified_by', 'required'),
			array('event_city_id, event_category_id, event_business_id, created_by, modified_by, event_views', 'numerical', 'integerOnly'=>true),
			...
			array('event_show_map, is_featured, is_popular', 'length', 'max'=>1),
			array('event_latitude, event_longitude', 'length', 'max'=>10),
			array('event_status', 'length', 'max'=>9),
			array('event_description, event_start_time, event_end_time, event_photo, created_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('event_id, event_title, event_description, event_type, event_start_date, event_end_date, event_start_time, event_end_time, event_frequency, event_address1, event_address2, event_street, event_city_id, event_phone_no, event_show_map, event_photo, event_category_id, event_business_id, event_latitude, event_longitude, event_tag, created_time, modified_time, created_by, modified_by, is_featured, is_popular, event_status, cost, event_views', 'safe', 'on'=>'search'),
		);
	}
