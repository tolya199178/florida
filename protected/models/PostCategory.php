 ...
 */
 ...
 /**
 * PostCategory activerecord model class provides a mechanism to keep data and their
 ...
 * ...or
 * ...   $category = new PostCategory($scenario);
 *
 * @package   Components
...
class PostCategory extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'parent'             => array(self::BELONGS_TO, 'PostCategory', 'parent_id'),
			'postQuestions'      => array(self::HAS_MANY,   'PostQuestion', 'post_category_id'),
		);
	}
