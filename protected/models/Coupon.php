...
class Coupon extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('business_id, redeemed_by, number_of_uses, created_by, modified_by', 'numerical', 'integerOnly'=>true),
			array('coupon_name', 'length', 'max'=>250),
			array('coupon_type', 'length', 'max'=>7),
			array('coupon_photo', 'length', 'max'=>1024),
			array('coupon_description', 'length', 'max'=>4096),
			array('coupon_code', 'length', 'max'=>32),
			array('printed', 'length', 'max'=>1),
			array('cost', 'length', 'max'=>10),
			array('coupon_expiry, terms, created_time, modified_time', 'safe'),
