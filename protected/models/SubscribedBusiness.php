...
class SubscribedBusiness extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('subscribed_business_id, user_id, business_id', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'subscribed_business_id' => 'Subscribed Business',
			'user_id' => 'User',
	...
	public function search()
	{
		...
		$criteria->compare('subscribed_business_id',$this->subscribed_business_id);
