...
LIMIT 0 , $numberOfResults
    ...
    private function searchEvents($argDoWhat, $argWithWhat, $argWhere, $argWhen)
    {
        ...
        if (! empty($argDoWhat)) {
            $activitySearchCriteria->addCondition( "FIND_IN_SET(:activity_keyword_tag,
                                          CONCAT(`t`.keyword,',',IFNULL(`t`.related_words,'')))");
        ...
        // /////////////////////////////////////////////////////////////////////
        // We search through the list of activities and activity types, because
        // ...this is what user's will search for. From the activity, we extract
        // ...a list of related event categories, then use that category list to
        // ...search the event<->event_category table join.
        // /////////////////////////////////////////////////////////////////////


        // /////////////////////////////////////////////////////////////////////
        // The activities willl appear as lists of comma-delimited keywords. We
        // ...expand these lists further to produce a flattened single list.
        // /////////////////////////////////////////////////////////////////////
        ...
        $listEvent = Yii::app()->db->createCommand()
                        ...
                        ->leftJoin('tbl_event_category event_category', 'event_category.category_id = event.event_category_id')
                        ->where('event.event_city_id = :city_id', array(':city_id'=>$cityId))
                        ->andwhere(array('in', 'event_category.category_name', $listEventCategory))
                        ->queryAll();
