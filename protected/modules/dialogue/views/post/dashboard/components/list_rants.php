...
<div class="qa-list list-group">
    <?php if (!empty($listRants)) {
            foreach ($listRants as $itemQuestion) { ?>
            ...
            <div class="qa-panels">
                ...
                <div class="qa-panel ranking">
                    ...
                    <?php
                        ...
                        if ($itemQuestion->question_rating_value == 1)
                        {
                            echo  '<span class="glyphicon glyphicon-star"></span>';
                        }
                        else if ($itemQuestion->question_rating_value == 2)
                        {
