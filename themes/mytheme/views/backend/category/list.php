        ...
        <div>
            <div class="navbar-form navbar-left" role="search">
                <div class="form-group">
                    <a
                        href="<?php echo Yii::app()->createUrl('category/create'); ?>"
...
<?php
    $data_url = Yii::app()->createUrl('category/listjson');
    $edit_url = Yii::app()->createUrl('category/edit');
    $delete_url = Yii::app()->createUrl('category/delete');
    ...
    var table = $('#category_table').DataTable({
            ...
            'columnDefs': [
                ...
                // In row edit button
                {
                    ...
                    "data": null,
                    'render': function ( data, type, row ) {
                        var editurl = "<a class='editrow btn btn-info btn-xs' href='{$edit_url}/category_id/" + row[0] + "'>Edit</a>";
                        // alert(editurl);
                        return editurl;
                    },
                },
        ...
        $('#category_table tbody').on( 'click', 'button', function () {
            ...
            var result = window.confirm("Do you really want to Delete the category record for " + data[1] + "?");
            if (result == false) {
                e.prcategoryDefault();
                return false;
            }
        ...
        return true;
          ...
          if (className == "editrow") {
            ...
            //  $('#myModal').modal('show');
            url = "{$edit_url}/category_id/" + data[0];
            $('#myModal').removeData();
                $('#myModal').modal({
                    remote : url
                });
