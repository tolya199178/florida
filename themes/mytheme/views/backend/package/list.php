            ...
            <div id="popover-content" class="hide">
                ...
                <form name="searchform" id="searchform" action="" method="post">
                    <div class="form">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <?php echo CHtml::label('Package Name','package_name',array('class'=>"col-sm-2 control-label")); ?>
                                <div class="col-sm-10">
                                    <?php echo CHtml::textField('package_name','',array('class'=>"form-control")); ?>
                                </div>
                            </div>
                        </div>
    ...
    var table = $('#package_table').DataTable({
            ...
            'columnDefs': [
                ...
                // In row edit button
                {
                    ...
                    "data": null,
                    'render': function ( data, type, row ) {
                        var editurl = "<a class='editrow btn btn-info btn-xs' href='{$edit_url}/package_id/" + row[0] + "'>Edit</a>";
                        // alert(editurl);
                        return editurl;
                    },
                },
        ...
        $('#package_table tbody').on( 'click', 'button', function () {

            var className = this.className;

            var data = table.row( $(this).parents('tr') ).data();

            var result = window.confirm("Do you really want to Delete the package record for " + data[1] + "?");
            if (result == false) {
                e.preventDefault();
                return false;
            }
